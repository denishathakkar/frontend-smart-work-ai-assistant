...
export const WidgetHeader = ({ botMode }: WidgetHeaderProps) => {
  ...
  return (
    <>
      <div
        className={clsx(
          'tw-relative tw-flex tw-cursor-default tw-items-center tw-space-x-4 tw-p-2 tw-shadow-lg tw-drop-shadow',
          `tw-h-[7rem]`,
          {
            'tw-rounded-t-[1.8rem]': botMode === 'web', // Rounded corners for widget mode
            'tw-rounded-none': botMode === 'app', // No rounded corners for app mode
          }
